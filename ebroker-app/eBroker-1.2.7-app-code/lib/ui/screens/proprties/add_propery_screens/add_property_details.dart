...
class _AddPropertyDetailsState extends State<AddPropertyDetails>
                ...
                children: <Widget>[
                  ...
                  AdaptiveImagePickerWidget(
                    ...
                    onRemove: (value) {
                      ...
                      final wasServerUrl =
                          (metaImage is UrlValue) && metaImageUrl.isNotEmpty;
  ...
  bool _hasAllowedExtension(String path) {
    final allowedExtensions = <String>{'jpg', 'jpeg', 'png'};
                ...
                onTap: () async {
                  try {
                    ...
                    if (image != null) {
                      ...
                      if (_validateImageSize(file) && hasAllowedExtension) {
                        // Manually set the picked file and notify listeners
                        _pickTitleImage.pickedFile = file;
                        titleImageURL = '';
                        setState(() {});
                      } else {
                        if (!hasAllowedExtension) {
            ...
            uploadPhotoCard(
              ...
              onTap: () async {
                try {
                  ...
                  if (image != null) {
                    final file = File(image.path);
                    final hasAllowedExtension = _hasAllowedExtension(file.path);
                    if (_validateImageSize(file) && hasAllowedExtension) {
                      // Manually set the picked file and notify listeners
                      _pickTitleImage.pickedFile = file;
                      titleImageURL = '';
                      ...
                      _showImageError(
                        isFromAllowedExtension: hasAllowedExtension,
                      );
                    }
                  }
                } on Exception catch (_) {}
