...
class _DateTimeSelectionStepState extends State<DateTimeSelectionStep> {
  ...
  void _loadMonthlyTimeSlots() {
    context.read<FetchMonthlyTimeSlotsCubit>().fetchMonthlyTimeSlots(
  ...
  void _onPageChangedWithAPI(DateTime focusedDay) {
