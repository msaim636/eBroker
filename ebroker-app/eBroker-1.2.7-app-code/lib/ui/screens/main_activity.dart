                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            'dontshowagain'.translate(context),
                          ),
                        ],
                      ),
                    ],
                                  ...
                                  try {
                                    if (!isProfileCompleted) {
                                      await UiUtils.showBlurredDialoge(
                                        context,
                                        dialog: BlurredDialogBox(
                                          title: 'completeProfile'.translate(
                                            context,
                                          ),
                                          isAcceptContainesPush: true,
                                          onAccept: () async {
                                      ...
                                      await UiUtils.showBlurredDialoge(
                                        ...
                                        dialog: BlurredDialogBox(
                                          content: CustomText(
                                            'completeAgentVerificationToContinue'
                                                .translate(
                                                  context,
                                                ),
                                          ),
                                          title: 'agentVerificationRequired'
                                              .translate(context),
                                          isAcceptContainesPush: true,
                                          onAccept: () async {
