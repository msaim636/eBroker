...
class _RecordButtonState extends State<RecordButton> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        if ((timer?.isActive ?? false) && !isLocked)
          lockSlider()
        else
  ...
  Widget lockSlider() {
    ...
    return PositionedDirectional(
      bottom: -lockerAnimation.value + kBottomNavigationBarHeight,
      child: Container(
        height: lockerHeight,
        width: size,
        ...
        child: Column(
          children: [
            ...
            FlowShader(
              ...
              child: Column(
                children: [
                  Icon(Icons.keyboard_arrow_up, color: iconColor),
                  Icon(Icons.keyboard_arrow_up, color: iconColor),
                  Icon(Icons.keyboard_arrow_up, color: iconColor),
                ],
              ),
  ...
  Widget cancelSlider() {
    return PositionedDirectional(
      end: -timerAnimation.value + kBottomNavigationBarHeight - 10,
      top: -10,
      child: Container(
        height: size,
        width: timerWidth,
