...
class LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildMobileField() {
    return CustomTextFormField(
      ...
      suffix: GestureDetector(
        ...
        child: Container(
          margin: EdgeInsetsDirectional.all(8.rw(context)),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  _handleTermsAndConditionsTap(context);
                },
                child: CustomText(
              ...
              GestureDetector(
                onTap: () {
                  _handlePrivacyPolicyTap(context);
                },
                child: CustomText(
  ...
  void _handleTermsAndConditionsTap(BuildContext context) {
    Navigator.pushNamed(
      context,
