...
//       final date = DateTime.parse((chats[i] as ChatWidget).time).toLocal();
...
//   static void attachListener(void Function(List<dynamic>)? onData) {
//     _chatMessageStream.stream.listen(onData);
//   }

//   static void removeMessage({required id}) {
//     final msgs = messages
//       ..removeWhere((element) {
//         if (element is! Padding) {
//           return ((element as ChatWidget).key! as ValueKey).value == id;
//         }
//         return false;
//       });
...
//             try {
//               final chatMessage = ChatWidget.fromMap(map);
