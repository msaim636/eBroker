...
class SettingController extends Controller
{
    ...
    public function systemSettingsIndex(){
        ...
        $settingsArray = array(
            ...
            'number_with_otp_login','otp_service_provider','twilio_account_sid','twilio_auth_token','twilio_my_phone_number','social_login',
            ...
            'bank_transfer_status','default_language',
            'notify_user_for_subscription_expiry','days_before_subscription_expiry','homepage_location_alert_status','gemini_api_key','gemini_ai_search'
        );
        $systemSettings = HelperService::getMultipleSettingData($settingsArray);

        return view('settings.system-settings', compact('systemSettings', 'languages', 'languagesWithEnglish', 'stripe_currencies','paypalCurrencies', 'listOfCurrencies', 'bankDetailsFields'));
    }
    ...
    public function modifyMailTemplateIndex($type){
        ...
        $templateMailData = HelperService::getSettingData($data['type']);
