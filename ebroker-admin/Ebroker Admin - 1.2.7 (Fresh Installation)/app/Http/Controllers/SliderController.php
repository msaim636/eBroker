    ...
    public function update(Request $request,$id)
    {
        if (!has_permissions('update', 'slider')) {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'edit_image' => 'required_if:edit_image_missing,1|mimes:jpg,png,jpeg|max:2048',
                'edit_web_image' => 'required_if:edit_web_image_missing,1|mimes:jpg,png,jpeg|max:2048',
            ], [
