...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        /** Add Data */
        $featureData = array(
            ['id' => 1, 'name' => config('constants.FEATURES.PROPERTY_LIST.NAME'), 'status' => 1],
            ['id' => 2, 'name' => config('constants.FEATURES.PROPERTY_FEATURE.NAME'), 'status' => 1],
            ['id' => 3, 'name' => config('constants.FEATURES.PROJECT_LIST.NAME'), 'status' => 1],
            ['id' => 4, 'name' => config('constants.FEATURES.PROJECT_FEATURE.NAME'), 'status' => 1],
            ['id' => 5, 'name' => config('constants.FEATURES.MORTGAGE_CALCULATOR_DETAIL.NAME'), 'status' => 1],
            ['id' => 6, 'name' => config('constants.FEATURES.PREMIUM_PROPERTIES.NAME'), 'status' => 1],
            ['id' => 7, 'name' => config('constants.FEATURES.PROJECT_ACCESS.NAME'), 'status' => 1],
        );
