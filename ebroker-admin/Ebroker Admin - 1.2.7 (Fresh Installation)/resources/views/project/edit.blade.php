                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @foreach($languages as $key => $language)
                            @php
                                $tTitle = optional($project->translations)->where('language_id', $language->id)->where('key', 'title')->first();
                                $tDesc  = optional($project->translations)->where('language_id', $language->id)->where('key', 'description')->first();
                            @endphp
                            <div class="bg-light p-3 mt-2 rounded">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="translations[{{ $key }}][description][value]" id="translation-description-{{ $language->id }}" class="form-control" placeholder="{{ __('Enter Description') }}">{!! $tDesc->value ?? '' !!}</textarea>
                                </div>
                            </div>
                        @endforeach
                    </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @foreach($project->translations as $key => $translation)
