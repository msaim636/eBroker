        ...
        <div class="sidebar-menu">
            <ul class="menu" id="sidebarMenu">
                ...
                @if (has_permissions('read', 'appointment_management'))
                    <li class="sidebar-item">
                        <a href="{{ route('appointment-management.index') }}" class='sidebar-link'>
                ...
                @if (has_permissions('read', 'appointment_reports'))
                    <li class="sidebar-item">
                        <a href="{{ route('admin.appointment.reports.index') }}" class='sidebar-link'>
                            <i class="bi bi-flag"></i>
                            <span class="menu-item">{{ __('Appointment Reports') }}</span>
                        </a>
                    </li>
                @endif
                ...
                {{-- Package --}}
                @if (has_permissions('read', 'package') || has_permissions('read', 'package-feature') || has_permissions('create', 'package-feature') || has_permissions('read', 'package') || has_permissions('create', 'package') || has_permissions('read', 'user_package') || has_permissions('read', 'payment'))
                    <li class="sidebar-item has-sub">
                        <a href="#" class='sidebar-link'>
                ...
                @if (has_permissions('read', 'users_accounts') ||
                        ...
                        has_permissions('read', 'admin_appointment_schedules'))
