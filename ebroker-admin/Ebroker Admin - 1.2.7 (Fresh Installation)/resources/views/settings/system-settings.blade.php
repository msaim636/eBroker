                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    {{-- <div class="col-sm-12 col-md-6 mt-2 form-group">
                                        <label class="form-check-label" for="switch_gemini_ai_search">{{ __('Enable Gemini AI Search') }}</label>
                                        <div>
                                            <div class="form-check form-switch ">
                                                <input type="hidden" name="gemini_ai_search" id="gemini_ai_search" value="{{ isset($systemSettings['gemini_ai_search']) && $systemSettings['gemini_ai_search'] != '' ? $systemSettings['gemini_ai_search'] : 0 }}">
                                                <input class="form-check-input" type="checkbox" role="switch" {{ isset($systemSettings['gemini_ai_search']) && $systemSettings['gemini_ai_search'] == '1' ? 'checked' : '' }} id="switch_gemini_ai_search">
                                            </div>
                                        </div>
                                    </div> --}}

                                    {{-- Gemini API Key --}}
                                    {{-- <div class="col-sm-12 col-md-6 mt-2 form-group" id="gemini-api-key-div" style="display: {{ isset($systemSettings['gemini_ai_search']) && $systemSettings['gemini_ai_search'] == '1' ? 'block' : 'none' }}">
                                        <label class="col-sm-12 form-label" for="gemini-api-key">{{ __('Gemini API Key') }}</label>
                                        <input name="gemini_api_key" type="text" id="gemini-api-key" class="form-control" placeholder="{{ __('Gemini API Key') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['gemini_api_key']) && $systemSettings['gemini_api_key'] != '' ? $systemSettings['gemini_api_key'] : '' ) : '****************************' ) : ( isset($systemSettings['gemini_api_key']) && $systemSettings['gemini_api_key'] != '' ? $systemSettings['gemini_api_key'] : '' ))}}">
                                    </div> --}}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="paypal_webhook_url" type="text" class="form-control" placeholder="{{ __('Paypal Webhook URL') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['paypal_webhook_url']) && $systemSettings['paypal_webhook_url'] != '' ? $systemSettings['paypal_webhook_url'] : '' ) : '****************************' ) : ( isset($systemSettings['paypal_webhook_url']) && $systemSettings['paypal_webhook_url'] != '' ? $systemSettings['paypal_webhook_url'] : url('/webhook/paypal') ))}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="razorpay_webhook_url" type="text" class="form-control" placeholder="{{ __('Razorpay Webhook URL') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['razorpay_webhook_url']) && $systemSettings['razorpay_webhook_url'] != '' ? $systemSettings['razorpay_webhook_url'] : '' ) : '****************************' ) : ( isset($systemSettings['razorpay_webhook_url']) && $systemSettings['razorpay_webhook_url'] != '' ? $systemSettings['razorpay_webhook_url'] : url('/webhook/razorpay') ))}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="paystack_webhook_url" type="text" class="form-control" placeholder="{{ __('Paystack Webhook URL') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['paystack_webhook_url']) && $systemSettings['paystack_webhook_url'] != '' ? $systemSettings['paystack_webhook_url'] : '' ) : '****************************' ) : ( isset($systemSettings['paystack_webhook_url']) && $systemSettings['paystack_webhook_url'] != '' ? $systemSettings['paystack_webhook_url'] : url('/webhook/paystack') ))}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            ...
                            <input name="stripe_webhook_url" type="text" class="form-control" placeholder="{{ __('Stripe Webhook URL') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['stripe_webhook_url']) && $systemSettings['stripe_webhook_url'] != '' ? $systemSettings['stripe_webhook_url'] : '' ) : '****************************' ) : ( isset($systemSettings['stripe_webhook_url']) && $systemSettings['stripe_webhook_url'] != '' ? $systemSettings['stripe_webhook_url'] : url('/webhook/stripe') ))}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Flutterwave Webhook URL') }}</label>
                                <input name="flutterwave_webhook_url" type="text" class="form-control" placeholder="{{ __('Flutterwave Webhook URL') }}" value="{{ (env('DEMO_MODE') ? ( env('DEMO_MODE') == true && Auth::user()->email == 'superadmin@gmail.com' ? ( isset($systemSettings['flutterwave_webhook_url']) && $systemSettings['flutterwave_webhook_url'] != '' ? $systemSettings['flutterwave_webhook_url'] : '' ) : '****************************' ) : ( isset($systemSettings['flutterwave_webhook_url']) && $systemSettings['flutterwave_webhook_url'] != '' ? $systemSettings['flutterwave_webhook_url'] : url('/webhook/flutterwave') ))}}" readonly>
                        </div>
...
<script type="text/javascript">
        ...
        $("#switch_gemini_ai_search").on('change', function() {
            const enabled = $("#switch_gemini_ai_search").is(':checked');
            $("#gemini_ai_search").val(enabled ? 1 : 0);
            if (enabled) {
                $('#gemini-api-key-div').show();
            } else {
                $('#gemini-api-key-div').hide();
            }
        });

        // Initialize Gemini API key visibility on load
        $(document).ready(function(){
            const enabled = $("#switch_gemini_ai_search").is(':checked');
            if (enabled) {
                $('#gemini-api-key-div').show();
        ...
        $("#switch_gemini_ai_search").on('change', function() {
            $("#switch_gemini_ai_search").is(':checked') ? $("#gemini_ai_search").val(1) : $("#gemini_ai_search") .val(0);
            if (enabled) {
                $('#gemini-api-key-div').show();
            } else {
                $('#gemini-api-key-div').hide();
